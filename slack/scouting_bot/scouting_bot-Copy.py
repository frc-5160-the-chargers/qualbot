...
slack_token='xoxb-750533769617-745490430099-ZsgoeqasYs4rp7qNts9MMWMW'
...
class bot:
    ...
    def __init__(self):
        self.appClient = slack.WebClient(token=slack_token);
...
if __name__ == '__main__':
    ...
    rtm_client = slack.RTMClient(timeout=10,token=slack_token,ssl=ssl_context,connect_method="rtm.connect");
    rtm_client.start();
